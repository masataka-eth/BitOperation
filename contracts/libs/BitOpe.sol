...
library BitOpe {
  ...
  uint256 private constant BITSIZE_32 = 0xFFFFFFF;
  ...
  function set128(uint256 _src, uint256 _index, uint256 _setValue) internal pure returns (uint256) {
    assert(_index < 2);
    uint256 _maskdata = _src & (~BITSIZE_128);
    uint256 _setdata = _setValue;
    if(_index > 0){
       _maskdata = _src & BITSIZE_128;
       _setdata = _setdata << BITPOS_128;
    }
  ...
  function set64(uint256 _src, uint256 _index, uint256 _setValue) internal pure returns (uint256) {
    assert(_index < 4);
    uint256 _maskdata = _src & (~BITSIZE_64);
    uint256 _setdata = _setValue;
    if(_index > 0){
       _maskdata = _src & ~(BITSIZE_64 << (BITPOS_64 * _index));
       _setdata = _setdata << (BITPOS_64 * _index);
    }
    return (_maskdata | _setdata);
  }
  ...
  function get64(uint256 _src, uint256 _index) internal pure returns (uint256) {
    assert(_index < 4);
    uint256 _getdata = _src & BITSIZE_64;
    if(_index > 0){
       _getdata = (_src >> (BITPOS_64 * _index)) & BITSIZE_64;
    }
    return _getdata;
  }
  ...
  function set32(uint256 _src, uint256 _index, uint256 _setValue) internal pure returns (uint256) {
    assert(_index < 8);
    uint256 _maskdata = _src & (~BITSIZE_32);
    uint256 _setdata = _setValue;
    if(_index > 0){
       _maskdata = _src & ~(BITSIZE_32 << (BITPOS_32 * _index));
       _setdata = _setdata << (BITPOS_32 * _index);
    }
    return (_maskdata | _setdata);
  }
  ...
  function get32(uint256 _src, uint256 _index) internal pure returns (uint256) {
    assert(_index < 8);
    uint256 _getdata = _src & BITSIZE_32;
    if(_index > 0){
       _getdata = (_src >> (BITPOS_32 * _index)) & BITSIZE_32;
    }
    return _getdata;
  }
  ...
  function set16(uint256 _src, uint256 _index, uint256 _setValue) internal pure returns (uint256) {
    assert(_index < 16);
    uint256 _maskdata = _src & (~BITSIZE_16);
    uint256 _setdata = _setValue;
    if(_index > 0){
       _maskdata = _src & ~(BITSIZE_16 << (BITPOS_16 * _index));
       _setdata = _setdata << (BITPOS_16 * _index);
    }
    return (_maskdata | _setdata);
  }
  ...
  function get16(uint256 _src, uint256 _index) internal pure returns (uint256) {
    assert(_index < 16);
    uint256 _getdata = _src & BITSIZE_16;
    if(_index > 0){
       _getdata = (_src >> (BITPOS_16 * _index)) & BITSIZE_16;
    }
    return _getdata;
  }
  ...
  function set8(uint256 _src, uint256 _index, uint256 _setValue) internal pure returns (uint256) {
    assert(_index < 32);
    uint256 _maskdata = _src & (~BITSIZE_8);
    uint256 _setdata = _setValue;
    if(_index > 0){
       _maskdata = _src & ~(BITSIZE_8 << (BITPOS_8 * _index));
       _setdata = _setdata << (BITPOS_8 * _index);
    }
    return (_maskdata | _setdata);
  }
  ...
  function get8(uint256 _src, uint256 _index) internal pure returns (uint256) {
    assert(_index < 32);
    uint256 _getdata = _src & BITSIZE_8;
    if(_index > 0){
       _getdata = (_src >> (BITPOS_8 * _index)) & BITSIZE_8;
    }
    return _getdata;
  }
  ...
  function set16_forAux(uint64 _src,uint256 _index, uint64 _setValue) internal pure returns (uint64) {
    assert(_index < 4);
    uint64 _maskdata = _src & (~AUX_BITSIZE_16);
    uint64 _setdata = _setValue;
    if(_index > 0){
       _maskdata = _src & ~(AUX_BITSIZE_16 << (AUX_BITPOS_16 * uint64(_index)));
       _setdata = _setdata << (AUX_BITPOS_16 * uint64(_index));
    }
    return (_maskdata | _setdata);
  }
  ...
  function get16_forAux(uint64 _src, uint256 _index) internal pure returns (uint64) {
    assert(_index < 4);
    uint64 _getdata = _src & AUX_BITSIZE_16;
    if(_index > 0){
       _getdata = (_src >> (AUX_BITPOS_16 * _index)) & AUX_BITSIZE_16;
    }
    return _getdata;
  }
  ...
  function set8_forAux(uint64 _src, uint256 _index, uint64 _setValue) internal pure returns (uint64) {
    assert(_index < 8);
    uint64 _maskdata = _src & (~AUX_BITSIZE_8);
    uint64 _setdata = _setValue;
    if(_index > 0){
       _maskdata = _src & ~(AUX_BITSIZE_8 << (AUX_BITPOS_8 * uint64(_index)));
       _setdata = _setdata << (AUX_BITPOS_8 * uint64(_index));
    }
    return (_maskdata | _setdata);
  }
  ...
  function get8_forAux(uint64 _src, uint256 _index) internal pure returns (uint64) {
    assert(_index < 8);
    uint64 _getdata = _src & AUX_BITSIZE_8;
    if(_index > 0){
       _getdata = (_src >> (AUX_BITPOS_8 * _index)) & AUX_BITSIZE_8;
    }
    return _getdata;
  }
